<?php
    ...
    $loan__query = $con->prepare('SELECT * FROM user__permanent INNER JOIN user__customers ON user__permanent.customer__id = user__customers.customer__id INNER JOIN warehouse__products ON user__permanent.item__number = warehouse__products.item__number AND username = ? ORDER BY user__permanent.loan__date DESC');
