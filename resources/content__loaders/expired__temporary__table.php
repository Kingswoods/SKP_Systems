<?php
    ...
    {
        //Output table header
        echo '<table class="table table__striped table__main table__expired">';
            echo '<thead>';
                echo '<tr>';
