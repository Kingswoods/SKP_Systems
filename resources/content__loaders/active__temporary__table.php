<?php
    ...
    {
        //Output table header
        echo '<table class="table table__striped table__main table__temporary">';
            echo '<thead>';
                echo '<tr>';
            ...
            while($row = $loan__result->fetch_assoc())
            {
                echo '<tr class="user__link" data-userid='.$row['username'].'>';
                    ...
                    echo '<td>'.date("d/m/Y", strtotime($row['loan__expiration'])).'</td>';
                echo '<tr>';
            }
